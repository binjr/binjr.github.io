...
|------------------|-----------------------------------------|--------------|--------------------------------------------------------------|
| binjr v3.23.0 | **Debian** (10,11), **Ubuntu** (22.04+) | x84 64-bit   | [binjr APT Repository](https://repos.binjr.eu/apt)           |
| binjr v3.23.0 | **RHEL** (8,9), **Fedora** (36+)        | x84 64-bit   | [binjr RPM Repository](https://repos.binjr.eu/rpm)           |
| binjr v3.23.0 | **ArchLinux**                           | x84 64-bit   | [Arch User Repository](https://repos.binjr.eu/aur)           |
| binjr v3.23.0 | **Windows** (10[^2] or 11)              | x84 64-bit   | [Winget Community Repository](https://repos.binjr.eu/winget) |
